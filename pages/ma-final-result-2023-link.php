...
$description = "Check MA Final Result 2023. Download MA Final Year marksheet for English, Hindi, History, and more. Find university-wise result declaration dates and links.";
include '../header.php';
?>
...
<div class="result-container">
    ...
    <div class="content-section">
        <h2>Check MA Final (Part 2) Results</h2>
        <p>The <strong>MA Final Year Result 2023</strong> is now accessible for most state and central universities. Students can use their credentials to log in and view their consolidated marksheets.</p>

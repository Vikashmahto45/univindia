...
<div class="result-container">
    ...
    <div class="check-result-section">
        ...
        <ul class="steps-list">
            <li>Click on the direct link provided below.</li>
            <li>Enter your Roll Number as mentioned on your admit card.</li>
            <li>Click on the 'Submit' button.</li>
            <li>Your RBSE 10th Result 2023 will be displayed on the screen.</li>
            <li>Download the result and take a printout for future reference.</li>
        </ul>
    ...
    <div class="details-section">
        ...
        <p>Once you access the result through the RBSE 10th Class Result 2023 Link, ensure all the following details are correct:</p>
        <table class="data-table">
            <tr><td>Student Name</td><td>Father's Name</td></tr>
            <tr><td>Roll Number</td><td>School Code</td></tr>

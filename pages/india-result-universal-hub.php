...
<main class="main-content">
        ...
        <div class="container">
            <div class="content-wrapper animate-up">
                ...
                <ul>
                    ...
                    <li>Select your respective State and the Education Board or University on the universal portal.</li>
    ...
    <section id="faq" class="faq-section">
        <div class="container">
            <h2 class="section-title">Universal Result FAQ</h2>
